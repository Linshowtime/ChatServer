...
@RestController  
@RequestMapping("/api/auth/uploadDownload")  
public class UploadDownloadController { 
    ...
    public Result uploadImage(@RequestParam(value = "file") MultipartFile file,HttpServletRequest request) throws RuntimeException {  
        if (file.isEmpty()) {  
